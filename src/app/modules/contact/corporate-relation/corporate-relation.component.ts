...
@Component({
  selector: 'app-corporate-relation',
  templateUrl: './corporate-contact.relation.html',
  styleUrls: ['./corporate-contact.relation.scss'],
  encapsulation: ViewEncapsulation.Emulated
})
export class CorporateRelationComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  ngOnInit() {
    this.pagetitle.setTitle("Corporate Relation");
      ...
      this.contactsService
        ...
        .subscribe(suc => {
            const res: any = suc;
              ...
              if(data == -1){
                this.showWarningPopup(this.errorData.deactivate_corporate_relation);
              }
              else{
